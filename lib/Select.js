...
var Select = (0, _createReactClass2['default'])({
	...
	propTypes: {
		...
		isOpen: _propTypes2['default'].bool, // sljfalskdf
	...
	componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
		...
		if (this.menu && isFocused && this.state.isOpen && !this.hasScrolledToOption) {
			var focusedOptionNode = _reactDom2['default'].findDOMNode(isFocused);
		...
		if (this._scrollToFocusedOptionOnUpdate && isFocused && this.menu) {
			...
			var focusedDOM = _reactDom2['default'].findDOMNode(isFocused);
